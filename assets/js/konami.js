...
(function () {
    ...
    // var burgerBites = [B, U, R, G, E, R, B, I, T, E, S];
    var burgerBites = [P, O, R, R, A, D, A];
    ...
    function isKonamiKey(e) {
        ...
        } else if (konamiDetected.length === burgerBites.length) {
            for (var j = 0, max = konamiDetected.length; j < max; j++) {
                if (konamiDetected[j] !== burgerBites[j]) {
                    codeOk = false;
                }
            }
            // Clean the array
